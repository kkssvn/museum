...
<div class="site-login" style="margin-top: 60px">
    ...
    <p style="color: #FFF; font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 300; line-height: normal;">Пожалуйста, введите данные, чтобы войти в аккаунт:</p>
        ...
        <div class="col-lg-5">
            ...
            <div class="form-group">
                <div style="background: #892810; border-radius: 50px; color: white; text-align: center; padding-top:5px; padding-bottom: 5px">
                    <?= Html::submitButton('Войти', ['style' => 'color:white; background: #892810; border:none;', 'name' => 'login-button']) ?>
                </div>
            </div>
